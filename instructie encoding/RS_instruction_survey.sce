...
sound {wavefile {filename = "surveydeel1ms.wav"; }; }dieren1;
sound {wavefile {filename = "surveydeel2ms.wav"; }; }dieren2;
...
Probeer je de dierentuin levendig voor te stellen en de informatie die genoemd wordt zo goed mogelijk te onthouden.
...
Als je er klaar voor bent druk dan nogmaals op de spatiebalk om te beginnen met de herhalingen. Succes!";
		};
		x = 0 ; y = 0 ;
	};
