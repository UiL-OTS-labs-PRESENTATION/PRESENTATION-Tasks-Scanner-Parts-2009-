...
#instructie
sound {wavefile {filename = "R1_uitleg_1.wav"; }; }R1_uitleg_1;	 
sound {wavefile {filename = "R1_uitleg_2.wav"; }; }R1_uitleg_2;	 
sound {wavefile {filename = "R1_uitleg_3a.wav"; }; }R1_uitleg_3a;
sound {wavefile {filename = "R1_uitleg_3b.wav"; }; }R1_uitleg_3b;	 
sound {wavefile {filename = "R1_uitleg_4.wav"; }; }R1_uitleg_4;	 
sound {wavefile {filename = "R1_uitleg_5.wav"; }; }R1_uitleg_5;	 

# 1 Algemene uitleg taak 
trial {
	trial_duration = stimuli_length;
   sound R1_uitleg_1; code = "R1_uitleg_1";
	nothing {}; delta_time = 1500;
};

trial {
	trial_duration = stimuli_length;
   sound R1_uitleg_2; code = "R1_uitleg_2";
	nothing {}; delta_time = 1500;
};

trial {
	trial_duration = stimuli_length;
   sound R1_uitleg_3a; code = "R1_uitleg_3a";
	nothing {}; delta_time = 1500;
};
...
trial {
	trial_duration = stimuli_length;
   sound R1_uitleg_3b; code = "R1_uitleg_3b";
	nothing {}; delta_time = 1500;
};
...
trial {
   ...
   terminator_button = 1;             	# press left
	sound R1_uitleg_4; code = "R1_uitleg_4";
};
...
trial {
	trial_duration = stimuli_length;
   sound R1_uitleg_5; code = "R1_uitleg_5";
	nothing {}; delta_time = 1500;
};
...
trial {
	trial_duration = stimuli_length;
   sound filler5; code = "voorbeeld_filler5";
   nothing {}; delta_time = 1500;
};
