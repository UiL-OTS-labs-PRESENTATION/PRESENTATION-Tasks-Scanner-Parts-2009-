...
sound {wavefile {filename = "goed.wav"; }; }introductiekoffer;	 
sound {wavefile {filename = "goed.wav"; }; }kofferinstr1;	 #wav nog aanpassen!
sound {wavefile {filename = "goed.wav"; }; }kofferinstr2;	 #wav nog aanpassen!
sound {wavefile {filename = "goed.wav"; }; }kofferinstr3;	 #wav nog aanpassen!
...
trial {
   ...
   terminator_button = 1;             	# press left
	sound introductiekoffer; code = "introductiekoffer";
};
...
trial {
   ...
   trial_type = specific_response;    	# trial ends when response
   terminator_button = 1;             	# press left
	sound kofferinstr1; code = "kofferinstr1";
};
...
trial {
   ...
   trial_type = specific_response;    	# trial ends when response
   terminator_button = 1;             	# press left
	sound kofferinstr2; code = "kofferinstr2";
};
...
trial {
   ...
   trial_type = specific_response;    	# trial ends when response
   terminator_button = 1;             	# press left
	sound kofferinstr3; code = "kofferinstr3";
};
...
trial {
   ...
   trial_type = specific_response;    	# trial ends when response
   terminator_button = 1;             	# press left
	sound oefentrialsbegin; code = "oefentrialsbegin";
};
...
hemd		rood		"hemdrood"			jas				groen			"jasgroen"		1		"heroo_jagr_ff_1P";
rok 		wit		"rokwit"				jurk				blauw			"jurkblauw"		2		"rokwi_jubl_gf_2P";
trui		bruin		"truibruin"			vest				paars			"vestpaars"		2		"trbru_vepa_fg_2P";
shirt		zwart		"shirtzwart"		broek				geel			"broekgeel"		1		"shzw_broge_gg_1P";
...
trial {
   ...
   trial_type = specific_response;    	# trial ends when response
   terminator_button = 1;             	# press left
	sound oefentrialseinde; code = "oefentrialseinde";
};
...
trial {
   ...
   trial_type = specific_response;    	# trial ends when response
   terminator_button = 1;             	# press left
	sound laatstecheck; code = "laatstecheck";
};
